...
public class Student {
    public static void main(String[] args) {   
        ...
        studentDate.printData();
        studentDate2.printData();
        studentDate3.printData();

        System.out.println(studentDate.getStudentScore("c++언어"));
        System.out.println(studentDate2.getStudentScore("c++언어"));
        System.out.println(studentDate3.getStudentScore("c++언어"));
    }
}